        ...
        <svg class="dv-border-svg-container" :width="width" :height="height">
            <defs>
                ...
                <mask :id="maskId">
                    <polyline
                        ...
                        stroke-width="3"
                        fill="transparent"
                        :points="`8, ${height * 0.4} 8, 3, ${
                            width * 0.4 + 7
                        }, 3`"
                    />
                    <polyline
                        fill="#fff"
                        :points="`8, ${height * 0.15} 8, 3, ${
                            width * 0.1 + 7
                        }, 3
            ...
            `"
                    ...
                    <polyline
                        ...
                        stroke-width="3"
                        fill="transparent"
                        :points="`${width * 0.35}, ${height - 3} ${
                            width - 3
                        }, ${height - 3} ${width - 3}, ${height * 0.35}`"
                    />
                    <polyline
                        fill="#fff"
                        :points="`
    ...
    export default {
        ...
        methods: {
            mergeColor() {
                ...
                this.mergedColor = deepMerge(
                    deepClone(defaultColor, true),
                    color || []
                )
            }
        },
