...
})()(
    {
        ...
        2: [
                ...
                function abstractBezierCurveToPolyline(bezierCurve) {
                    ...
                    var getSegmentTPointFuns = segments.map(function (seg, i) {
                        ...
                        return createGetBezierCurveTPointFun.apply(
                            void 0,
                            [beginPoint].concat(
                                (0, _toConsumableArray2['default'])(seg)
                            )
                        )
            ...
            },
            {
                ...
                '@babel/runtime/helpers/slicedToArray': 12,
        ...
        3: [
            function (require, module, exports) {
                ...
                function getSymmetryPoint(point, centerPoint) {
                    ...
                    var _centerPoint = (0, _slicedToArray2['default'])(
                            centerPoint,
                            2
                        ),
                        cx = _centerPoint[0],
        ...
        4: [
            ...
            {
                './core/bezierCurveToPolyline': 2,
                './core/polylineToBezierCurve': 3,
                '@babel/runtime/helpers/interopRequireDefault': 7
            }
        ],
        5: [
