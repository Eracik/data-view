...
function polylineToBezierCurve(polyline) {
    var close =
        arguments.length > 1 && arguments[1] !== undefined
            ...
            : false
    var offsetA =
        arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.25
    var offsetB =
        arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0.25
...
function getBezierCurveLineControlPoints(polyline, index) {
    ...
    var offsetA =
        arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0.25
    var offsetB =
        arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0.25
