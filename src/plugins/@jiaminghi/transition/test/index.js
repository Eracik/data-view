...
const { transition, injectNewCurve } = require('../src/index')
...
describe('transition-Number', () => {
    ...
    it('Input an invalid tBC will automatically apply the default tBC', () => {
        expect(
            transition('invalid', startState, endState, frame)
        ).to.deep.ordered.equal(linearResult)
    })
...
describe('transition-Deep', () => {
    ...
    const testCurveResult = transition(
        testCurve,
        startState,
        endState,
        frame,
