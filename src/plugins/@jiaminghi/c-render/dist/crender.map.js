...
})()(
    {
        ...
        2: [
            function (require, module, exports) {
                ...
                var _bezierCurve = _interopRequireDefault(
                    require('@jiaminghi/bezier-curve')
                )

                var _util = require('../plugin/util')

                var _graphs = _interopRequireDefault(
                    require('../config/graphs')
                )
                ...
                function animation(callback, timeStamp) {
                    ...
                    requestAnimationFrame(
                        animation.bind(this, callback, timeStamp)
                    )
                }
                /**
                ...
                function animationAble(graphs) {
                    return graphs.find(function (graph) {
                        return (
                            ...
                            graph.animationFrameState.length
                        )
                    })
                }
                /**
                ...
                function mouseMove(e) {
                    ...
                    var activeGraph = graphs.find(function (graph) {
                        return (
                            graph.status === 'active' || graph.status === 'drag'
                        )
                    })
                    ...
                    var hoverAbleGraphs = graphs.filter(function (graph) {
                        return (
                            graph.hover &&
                            (typeof graph.hoverCheck === 'function' ||
                                graph.hoverRect)
                        )
                    })
                    ...
                    if (hoveredGraph) {
                        document.body.style.cursor =
                            hoveredGraph.style.hoverCursor
                    } else {
                    ...
                    if (hoverGraph)
                        hoverGraphMouseOuterIsFun =
                            typeof hoverGraph.mouseOuter === 'function'
                    if (hoveredGraph)
        ...
        3: [
            function (require, module, exports) {
                ...
                Graph.prototype.hoverCheckProcessor = function (
                    position,
                    _ref
                ) {
                    ...
                    if (hoverRect)
                        return _util.checkPointIsInRect.apply(
                            void 0,
                            [position].concat(
                                (0, _toConsumableArray2['default'])(hoverRect)
                            )
                        )
                ...
                Graph.prototype.attr = function (attrName) {
                    ...
                    var isObject =
                        (0, _typeof2['default'])(this[attrName]) === 'object'
                ...
                Graph.prototype.turnNextAnimationFrame = function (timeStamp) {
                    ...
                    this.animationFrameState = animationFrameState.filter(
                        function (state) {
                            return state.length
                        }
                    )
        ...
        4: [
            function (require, module, exports) {
                ...
                Style.prototype.colorProcessor = function (style) {
                    var reverse =
                        arguments.length > 1 && arguments[1] !== undefined
                            ? arguments[1]
                            : false
                    var processor = reverse
                        ? _color.getColorFromRgbValue
                        : _color.getRgbaValue
                ...
                function initTransform(ctx, style) {
                    ...
                    ctx.translate.apply(
                        ctx,
                        (0, _toConsumableArray2['default'])(graphCenter)
                    )
                    if (rotate) ctx.rotate((rotate * Math.PI) / 180)
                    if (scale instanceof Array)
                        ctx.scale.apply(
                            ctx,
                            (0, _toConsumableArray2['default'])(scale)
                        )
                    if (translate)
                        ctx.translate.apply(
                            ctx,
                            (0, _toConsumableArray2['default'])(translate)
                        )
                    ctx.translate(-graphCenter[0], -graphCenter[1])
                }

                var autoSetStyleKeys = [
                    'lineCap',
                    'lineJoin',
                    'lineDashOffset',
                    'shadowOffsetX',
                ...
                function initGraphStyle(ctx, style) {
                    ...
                    shadowColor = (0, _toConsumableArray2['default'])(
                        shadowColor
                    )
                    fill[3] *= opacity
                    stroke[3] *= opacity
                    ...
                    ctx.shadowColor = (0, _color.getColorFromRgbValue)(
                        shadowColor
                    )
                ...
                function initGradient(ctx, style) {
                    ...
                    gradientColor = gradientColor.map(function (color) {
                        ...
                        var clonedColor = (0, _toConsumableArray2['default'])(
                            color
                        )
                    ...
                    var gradient = ctx[
                        'create'.concat(
                            gradientType.slice(0, 1).toUpperCase() +
                                gradientType.slice(1),
                            'Gradient'
                        )
                    ].apply(
                        ctx,
                        (0, _toConsumableArray2['default'])(gradientParams)
                    )
                ...
                function gradientValidator(style) {
                    ...
                    if (
                        (gradientType === 'linear' &&
                            gradientParamsLength !== 4) ||
                        (gradientType === 'radial' &&
                            gradientParamsLength !== 6)
                    ) {
                        console.warn(
                    ...
                    if (
                        gradientStops !== 'auto' &&
                        !(gradientStops instanceof Array)
                    ) {
                        console.warn(
        ...
        5: [
            function (require, module, exports) {
                ...
                var polylineToBezierCurve =
                        _bezierCurve2['default'].polylineToBezierCurve,
                    bezierCurveToPolyline =
                        _bezierCurve2['default'].bezierCurveToPolyline
                var circle = {
                    shape: {
                        rx: 0,
                        ry: 0,
                    ...
                    hoverCheck: function hoverCheck(position, _ref4) {
                        ...
                        var rx = shape.rx,
                            ry = shape.ry,
                            r = shape.r
                        return (0, _util.checkPointIsInCircle)(
                            position,
                            rx,
                            ry,
                            r
                ...
                var ellipse = {
                    ...
                    validator: function validator(_ref8) {
                        ...
                        if (
                            ...
                            console.error(
                                'Ellipse shape configuration is abnormal!'
                            )
                            return false
                        }
                ...
                var rect = {
                    ...
                    validator: function validator(_ref15) {
                        ...
                        if (
                            ...
                            console.error(
                                'Rect shape configuration is abnormal!'
                            )
                            return false
                        }
                    ...
                    hoverCheck: function hoverCheck(position, _ref18) {
                        ...
                        var x = shape.x,
                            ...
                            w = shape.w,
                            h = shape.h
                        return (0, _util.checkPointIsInRect)(
                            position,
                            x,
                            y,
                            w,
                ...
                var ring = {
                    ...
                    validator: function validator(_ref22) {
                        ...
                        if (
                            ...
                            console.error(
                                'Ring shape configuration is abnormal!'
                            )
                            return false
                        }
                    ...
                    hoverCheck: function hoverCheck(position, _ref25) {
                        ...
                        var distance = (0, _util.getTwoPointDistance)(
                            position,
                            [rx, ry]
                        )
                        return (
                ...
                var arc = {
                    ...
                    validator: function validator(_ref29) {
                        ...
                        if (
                            ...
                            console.error(
                                'Arc shape configuration is abnormal!'
                            )
                            return false
                        }
                ...
                var sector = {
                    ...
                    validator: function validator(_ref36) {
                        ...
                        if (
                            ...
                            console.error(
                                'Sector shape configuration is abnormal!'
                            )
                            return false
                        }
                    ...
                    hoverCheck: function hoverCheck(position, _ref39) {
                        ...
                        var rx = shape.rx,
                            ...
                            endAngle = shape.endAngle,
                            clockWise = shape.clockWise
                        return (0, _util.checkPointIsInSector)(
                            position,
                            rx,
                            ry,
                            r,
                ...
                var regPolygon = {
                    ...
                    draw: function draw(_ref44, _ref45) {
                        ...
                        if (
                            ...
                            var _points = (0, _util.getRegularPolygonPoints)(
                                rx,
                                ry,
                                r,
                                side
                    ...
                    hoverCheck: function hoverCheck(position, _ref46) {
                        ...
                        var points = cache.points
                        return (0, _util.checkPointIsInPolygon)(
                            position,
                            points
                        )
                    },
                    ...
                    move: function move(_ref48, _ref49) {
                        ...
                        cache.points = cache.points.map(function (_ref50) {
                            var _ref51 = (0, _slicedToArray2['default'])(
                                    _ref50,
                                    2
                                ),
                                x = _ref51[0],
                ...
                var polyline = {
                    ...
                    draw: function draw(_ref53, _ref54) {
                        ...
                        var points = shape.points,
                            close = shape.close
                        if (lineWidth === 1)
                            points = (0, _util.eliminateBlur)(points)
                        ;(0, _canvas.drawPolylinePath)(ctx, points)
                    ...
                    hoverCheck: function hoverCheck(position, _ref55) {
                        ...
                        if (close) {
                            ...
                            return (0, _util.checkPointIsNearPolyline)(
                                position,
                                points,
                                lineWidth
                            )
                    ...
                    move: function move(_ref57, _ref58) {
                        ...
                        var moveAfterPoints = points.map(function (_ref59) {
                            var _ref60 = (0, _slicedToArray2['default'])(
                                    _ref59,
                                    2
                                ),
                                x = _ref60[0],
                ...
                var smoothline = {
                    ...
                    validator: function validator(_ref61) {
                        ...
                        if (!(points instanceof Array)) {
                            console.error(
                                'Smoothline points should be an array!'
                            )
                            return false
                        }
                    ...
                    draw: function draw(_ref62, _ref63) {
                        ...
                        if (
                            !cache.points ||
                            cache.points.toString() !== points.toString()
                        ) {
                            var _bezierCurve = polylineToBezierCurve(
                                points,
                                close
                            )

                            var hoverPoints =
                                bezierCurveToPolyline(_bezierCurve)
                            Object.assign(cache, {
                    ...
                    move: function move(_ref66, _ref67) {
                        ...
                        var moveAfterPoints = points.map(function (_ref68) {
                            var _ref69 = (0, _slicedToArray2['default'])(
                                    _ref68,
                                    2
                                ),
                                x = _ref69[0],
                        ...
                        cache.hoverPoints = cache.hoverPoints.map(function (
                            _ref72
                        ) {
                            var _ref73 = (0, _slicedToArray2['default'])(
                                    _ref72,
                                    2
                                ),
                                x = _ref73[0],
                ...
                var bezierCurve = {
                    ...
                    validator: function validator(_ref74) {
                        ...
                        if (!(points instanceof Array)) {
                            console.error(
                                'BezierCurve points should be an array!'
                            )
                            return false
                        }
                    ...
                    move: function move(_ref79, _ref80) {
                        ...
                        var _points$ = (0, _slicedToArray2['default'])(
                                points[0],
                                2
                            ),
                            fx = _points$[0],
                        ...
                        cache.hoverPoints = cache.hoverPoints.map(function (
                            ...
                            var _ref84 = (0, _slicedToArray2['default'])(
                                    _ref83,
                                    2
                                ),
                                x = _ref84[0],
                ...
                var text = {
                    ...
                    draw: function draw(_ref86, _ref87) {
                        ...
                        var _position = position,
                            _position2 = (0, _slicedToArray2['default'])(
                                _position,
                                2
                            ),
                            x = _position2[0],
                    ...
                    setGraphCenter: function setGraphCenter(e, _ref89) {
                        ...
                        style.graphCenter = (0, _toConsumableArray2['default'])(
                            position
                        )
                    },
                    move: function move(_ref90, _ref91) {
                        ...
                        var _shape$position = (0, _slicedToArray2['default'])(
                                shape.position,
                                2
                            ),
                            x = _shape$position[0],
        ...
        6: [
            function (require, module, exports) {
                ...
                var _crender = _interopRequireDefault(
                    require('./class/crender.class')
                )
            ...
            function (require, module, exports) {
                    ...
                    points.forEach(function (point, i) {
                        return (
                            ...
                            (i === 0
                                ? ctx.moveTo.apply(
                                      ctx,
                                      (0, _toConsumableArray2['default'])(point)
                                  )
                                : ctx.lineTo.apply(
                                      ctx,
                                      (0, _toConsumableArray2['default'])(point)
                ...
                function drawBezierCurvePath(ctx, points) {
                    ...
                    if (moveTo)
                        ctx.moveTo.apply(
                            ctx,
                            (0, _toConsumableArray2['default'])(moveTo)
                        )
                        ...
                        return (
                            ...
                            ctx.bezierCurveTo.apply(
                                ...
                                (0, _toConsumableArray2['default'])(
                                    ...
                                    (0, _toConsumableArray2['default'])(item[2])
                                )
                            )
                        )
                    })
        ...
        8: [
            function (require, module, exports) {
                ...
                exports.getDistanceBetweenPointAndLine =
                ...
                function deepClone(object) {
                    ...
                    if (
                        object &&
                        (0, _typeof2['default'])(object) === 'object'
                    ) {
                        for (var key in object) {
                            if (object.hasOwnProperty(key)) {
                                if (
                                    object[key] &&
                                    (0, _typeof2['default'])(object[key]) ===
                                        'object'
                                ) {
                ...
                function checkPointIsInSector(
                    ...
                    if (!clockWise) {
                        ...
                        var _deepClone2 = (0, _slicedToArray2['default'])(
                            _deepClone,
                            2
                        )
                    ...
                    var _getCircleRadianPoint = getCircleRadianPoint(
                            rx,
                            ry,
                            r,
                            startAngle
                        ),
                        _getCircleRadianPoint2 = (0,
                        _slicedToArray2['default'])(_getCircleRadianPoint, 2),
                        bx = _getCircleRadianPoint2[0],
                        by = _getCircleRadianPoint2[1]

                    var _getCircleRadianPoint3 = getCircleRadianPoint(
                            rx,
                            ry,
                            r,
                            endAngle
                        ),
                        _getCircleRadianPoint4 = (0,
                        _slicedToArray2['default'])(_getCircleRadianPoint3, 2),
                    ...
                    if (reverse) {
                        ...
                        var _deepClone4 = (0, _slicedToArray2['default'])(
                            _deepClone3,
                            2
                        )
                    ...
                    var inSector =
                        isClockWise(vBArm, vPoint) &&
                        !isClockWise(vEArm, vPoint)
                ...
                function getTranslatePointPos(translate, point) {
                    ...
                    var _translate = (0, _slicedToArray2['default'])(
                            translate,
                            2
                        ),
                        tx = _translate[0],
                ...
                function getDistanceBetweenPointAndLine(
                    point,
                    lineBegin,
                    lineEnd
                ) {
                    ...
                    var _lineBegin = (0, _slicedToArray2['default'])(
                            lineBegin,
                            2
                        ),
                        x1 = _lineBegin[0],
        ...
        20: [
            ...
            {
                './arrayWithoutHoles': 10,
                './iterableToArray': 15,
                './nonIterableSpread': 18
            }
        ],
        21: [
            function (require, module, exports) {
            ...
            function (require, module, exports) {
                ...
                function abstractBezierCurveToPolyline(bezierCurve) {
                    ...
                    var getSegmentTPointFuns = segments.map(function (seg, i) {
                        var beginPoint =
                            i === 0 ? startPoint : segments[i - 1][2]
                        return createGetBezierCurveTPointFun.apply(
                            void 0,
                            [beginPoint].concat(_toConsumableArray(seg))
                        )
                    }) // Initialize the curve to a polyline

                    var segmentPointsNum = new Array(segmentsNum).fill(
                        defaultSegmentPointsNum
                    )
                    var segmentPoints = getSegmentPointsByNum(
                        getSegmentTPointFuns,
                        segmentPointsNum
                    ) // Calculate uniformly distributed points by iteratively

                    var result = calcUniformPointsByIteration(
                        segmentPoints,
                        getSegmentTPointFuns,
                        segments,
                        precision
                ...
                function getSegmentPointsByNum(
                    ...
                    return getSegmentTPointFuns.map(function (
                        getSegmentTPointFun,
                        i
                    ) {
                ...
                function calcUniformPointsByIteration(
                    ...
                    var _loop = function _loop() {
                        ...
                        var totalPointsNum = segmentPoints.reduce(function (
                            total,
                            seg
                        ) {
                        ...
                        var segmentPointsDistance =
                            getSegmentPointsDistance(segmentPoints)
                        var lineSegmentNum = segmentPointsDistance.reduce(
                            function (total, seg) {
                                return total + seg.length
                            },
                            0
                        )
                        var segmentlength = segmentPointsDistance.map(function (
                            seg
                        ) {
                            return getNumsSum(seg)
                        })
                        ...
                        var allDeviations = getAllDeviations(
                            segmentPointsDistance,
                            avgLength
                        )
                        if (allDeviations <= precision) return 'break'
                        totalPointsNum = ceil(
                            (avgLength / precision) * totalPointsNum * 1.1
                        )
                        var segmentPointsNum = segmentlength.map(function (
                            length
                        ) {
                        ...
                        totalPointsNum = segmentPoints.reduce(function (
                            total,
                            seg
                        ) {
                            return total + seg.length
                        ...
                        0)
                        var segmentPointsForLength = JSON.parse(
                            JSON.stringify(segmentPoints)
                        )
                        segmentPointsForLength.forEach(function (seg, i) {
                            return seg.push(segments[i][2])
                        })
                        segmentPointsDistance = getSegmentPointsDistance(
                            segmentPointsForLength
                        )
                        lineSegmentNum = segmentPointsDistance.reduce(function (
                            total,
                            seg
                        ) {
                            return total + seg.length
                        ...
                        0)
                        segmentlength = segmentPointsDistance.map(function (
                            seg
                        ) {
                            return getNumsSum(seg)
                        })
                        ...
                        getSegmentTPointFuns.forEach(function (
                            getSegmentTPointFun,
                            i
                        ) {
                            var currentSegmentPointsNum = segmentPointsNum[i]
                            var t = new Array(currentSegmentPointsNum)
                                .fill('')
                                .map(function (foo, j) {
                            ...
                            for (var r = 0; r < rounds; r++) {
                                var distance = getSegmentPointsDistance([
                                    segmentPoints[i]
                                ])[0]
                                ...
                                for (
                                    ...
                                    if (t[j] > 1) t[j] = 1
                                    if (t[j] < 0) t[j] = 0
                                    segmentPoints[i][j] = getSegmentTPointFun(
                                        t[j]
                                    )
                                }
                            }
                ...
                function bezierCurveToPolyline(bezierCurve) {
                    ...
                    var _abstractBezierCurveT = abstractBezierCurveToPolyline(
                            bezierCurve,
                            precision
                        ),
        ...
        24: [
            function (require, module, exports) {
                ...
                function polylineToBezierCurve(polyline) {
                    ...
                    var bezierCurvePoints = new Array(bezierCurveLineNum)
                        .fill(0)
                        .map(function (foo, i) {
                            return [].concat(
                                _toConsumableArray(
                ...
                function getBezierCurveLineControlPoints(polyline, index) {
                    ...
                    if (beforePointIndex < 0)
                        beforePointIndex = close
                            ? pointNum + beforePointIndex
                            : 0
                    var afterPointIndex = index + 1
                    if (afterPointIndex >= pointNum)
                        afterPointIndex = close
                            ? afterPointIndex - pointNum
                            : pointNum - 1
                    var afterNextPointIndex = index + 2
                    if (afterNextPointIndex >= pointNum)
                        afterNextPointIndex = close
                            ? afterNextPointIndex - pointNum
                            : pointNum - 1
                    ...
                    return [
                        [
                            pointMiddle[0] +
                                offsetA * (pointAfter[0] - pointBefore[0]),
                            pointMiddle[1] +
                                offsetA * (pointAfter[1] - pointBefore[1])
                        ],
                        [
                            pointAfter[0] -
                                offsetB * (pointAfterNext[0] - pointMiddle[0]),
                            pointAfter[1] -
                                offsetB * (pointAfterNext[1] - pointMiddle[1])
                        ]
                    ]
                }
                /**
        ...
        25: [
            function (require, module, exports) {
                ...
                var _polylineToBezierCurve = _interopRequireDefault(
                    require('./core/polylineToBezierCurve')
                )
                ...
                var _default = {
                    bezierCurveToPolyline:
                        _bezierCurveToPolyline.bezierCurveToPolyline,
                    getBezierCurveLength:
                        _bezierCurveToPolyline.getBezierCurveLength,
                    polylineToBezierCurve: _polylineToBezierCurve['default']
                }
                exports['default'] = _default
            },
            {
                './core/bezierCurveToPolyline': 23,
                './core/polylineToBezierCurve': 24
            }
        ],
        26: [
            function (require, module, exports) {
        ...
        27: [
            function (require, module, exports) {
                ...
                var _keywords = _interopRequireDefault(
                ...
                function getRgbValueFromHex(color) {
                    ...
                    return new Array(3).fill(0).map(function (t, i) {
                        return parseInt(
                            '0x'.concat(color[i * 2]).concat(color[i * 2 + 1])
                        )
                    })
                }
                /**
                ...
                function getColorFromRgbValue(value) {
                    if (!value) {
                        console.error(
                            'getColorFromRgbValue: Missing parameters!'
                        )
                        return false
                    }
                ...
                function fade(color) {
                    ...
                    var rgbValue = getRgbValue(color)
                    if (!rgbValue) return false
                    var rgbaValue = [].concat(_toConsumableArray(rgbValue), [
                        percent / 100
                    ])
                    return getColorFromRgbValue(rgbaValue)
                }
