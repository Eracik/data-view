...
})()(
  {
    ...
    2: [
      ...
      },
      {
        ...
        '@/plugins/@jiaminghi/bezier-curve': 25,
        '@/plugins/@jiaminghi/color': 27
      }
    ],
    3: [
      function (require, module, exports) {
        ...
        Graph.prototype.turnNextAnimationFrame = function (timeStamp) {
          ...
          this.animationFrameState = animationFrameState.filter(function (
            state
          ) {
            return state.length
          })
      ...
      },
      {
        ...
        '@/plugins/@jiaminghi/transition': 29
      }
    ],
    4: [
      function (require, module, exports) {
        ...
        var _color = require('@/plugins/@jiaminghi/color')
        ...
        function initTransform(ctx, style) {
          ...
          if (scale instanceof Array)
            ctx.scale.apply(ctx, (0, _toConsumableArray2['default'])(scale))
          if (translate)
            ctx.translate.apply(
              ctx,
        ...
        function initGradient(ctx, style) {
          ...
          var gradient = ctx[
            'create'.concat(
              gradientType.slice(0, 1).toUpperCase() + gradientType.slice(1),
              'Gradient'
            )
          ].apply(ctx, (0, _toConsumableArray2['default'])(gradientParams))
      ...
      function (require, module, exports) {
        ...
        var ellipse = {
          ...
          hoverCheck: function hoverCheck(position, _ref11) {
            ...
            var distance =
              (0, _util.getTwoPointDistance)(position, leftFocusPoint) +
              (0, _util.getTwoPointDistance)(position, rightFocusPoint)
            return distance <= 2 * a
          },
        ...
        var smoothline = {
          ...
          move: function move(_ref66, _ref67) {
            ...
            var _cache$bezierCurve$ = (0, _slicedToArray2['default'])(
                cache.bezierCurve[0],
                2
              ),
            ...
            cache.bezierCurve = [[fx + movementX, fy + movementY]].concat(
        ...
        var bezierCurve = {
          ...
          move: function move(_ref79, _ref80) {
            ...
            var bezierCurve = [[fx + movementX, fy + movementY]].concat(
              (0, _toConsumableArray2['default'])(
                curves.map(function (curve) {
          ...
          draw: function draw(_ref86, _ref87) {
            ...
            content.forEach(function (text, i) {
              ctx.fillText.apply(
                ctx,
                [text].concat(
                  (0, _toConsumableArray2['default'])(position[i]),
                  [maxWidth]
                )
              )
    ...
    7: [
      function (require, module, exports) {
        ...
        function drawBezierCurvePath(ctx, points) {
          ...
          if (beginPath) ctx.beginPath()
          if (moveTo)
            ctx.moveTo.apply(ctx, (0, _toConsumableArray2['default'])(moveTo))
          points.forEach(function (item) {
            return (
              item &&
              ctx.bezierCurveTo.apply(
                ctx,
                (0, _toConsumableArray2['default'])(item[0]).concat(
                  (0, _toConsumableArray2['default'])(item[1]),
    ...
    8: [
      function (require, module, exports) {
          ...
          for (var i = 1, p1 = polygon[0]; i <= pointNum; i++) {
            ...
            if (x > min(p1[0], p2[0]) && x <= max(p1[0], p2[0])) {
              if (y <= max(p1[1], p2[1])) {
                if (p1[0] !== p2[0]) {
                  var xinters =
                    ((x - p1[0]) * (p2[1] - p1[1])) / (p2[0] - p1[0]) + p1[1]
        ...
        function checkPointIsInSector(
          ...
          var inSector =
            isClockWise(vBArm, vPoint) && !isClockWise(vEArm, vPoint)
      ...
      function (require, module, exports) {
        ...
        function calcUniformPointsByIteration(
          ...
          var _loop = function _loop() {
            ...
            var lineSegmentNum = segmentPointsDistance.reduce(function (
              total,
              seg
            ) {
              return total + seg.length
    ...
    25: [
      ...
      { './core/bezierCurveToPolyline': 23, './core/polylineToBezierCurve': 24 }
    ],
    26: [
      function (require, module, exports) {
        'use strict'
