...
var _cRender = require('@/plugins/@jiaminghi/c-render')

var _graphs = require('@/plugins/@jiaminghi/c-render/lib/config/graphs')
...
var pie = {
  ...
  draw: function draw(_ref2, _ref3) {
    ...
    var connectPoint1 = (0, _util.getCircleRadianPoint)(
      rx,
      ry,
      or,
      endAngle
    ...
    var connectPoint2 = (0, _util.getCircleRadianPoint)(
      rx,
      ry,
      ir,
      startAngle
...
var agArc = {
  ...
  draw: function draw(_ref5, _ref6) {
    ...
    for (var i = 0; i < gradientArcNum; i++) {
      ctx.beginPath()
      var startPoint = (0, _util.getCircleRadianPoint)(
        rx,
        ry,
        r,
        startAngle + angleGap * i
      )
      var endPoint = (0, _util.getCircleRadianPoint)(
        rx,
        ry,
        r,
        startAngle + angleGap * (i + 1)
      )
      var color = (0, _index.getLinearGradientColor)(
        ctx,
        startPoint,
        endPoint,
