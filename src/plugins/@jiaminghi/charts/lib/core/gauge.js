...
function calcGaugesAxisTickPosition(gauges, chart) {
  gauges.forEach(function (gaugeItem) {
    ...
    gaugeItem.tickPosition = new Array(splitNum).fill(0).map(function (foo, i) {
      ...
      return [
        _util.getCircleRadianPoint.apply(
          void 0,
  ...
  gauges.forEach(function (gaugeItem) {
    ...
    var detailsPosition = data.map(function (_ref3) {
      ...
      if (position === 'center') {
        ...
        point = _util.getCircleRadianPoint.apply(
          void 0,
          (0, _toConsumableArray2['default'])(center).concat([
            radius,
            startAngle
        ...
        point = _util.getCircleRadianPoint.apply(
          void 0,
          (0, _toConsumableArray2['default'])(center).concat([radius, endAngle])
        )
      }
...
function beforeChangeArc(graph, config) {
  ...
  if (cacheNum > needNum) {
    ...
    graphGradient.push.apply(
      graphGradient,
      (0, _toConsumableArray2['default'])(
        new Array(needNum - cacheNum).fill(0).map(function (foo) {
