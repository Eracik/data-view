...
function getAllAxis(xAxis, yAxis) {
    ...
    if (xAxis instanceof Array) {
        var _allXAxis
        ;(_allXAxis = allXAxis).push.apply(
            _allXAxis,
            (0, _toConsumableArray2['default'])(xAxis)
        )
    } else {
        allXAxis.push(xAxis)
    }
    ...
    if (yAxis instanceof Array) {
        var _allYAxis
        ;(_allYAxis = allYAxis).push.apply(
            _allYAxis,
            (0, _toConsumableArray2['default'])(yAxis)
        )
    } else {
        allYAxis.push(yAxis)
    }
    ...
    return [].concat(
        (0, _toConsumableArray2['default'])(allXAxis),
        (0, _toConsumableArray2['default'])(allYAxis)
    )
}
...
function mergeDefaultAxisConfig(allAxis) {
    ...
    xAxis = xAxis.map(function (axis) {
        return (0,
        _util.deepMerge)((0, _util2.deepClone)(_config.xAxisConfig), axis)
    })
    yAxis = yAxis.map(function (axis) {
        return (0,
        _util.deepMerge)((0, _util2.deepClone)(_config.yAxisConfig), axis)
    })
    return [].concat(
        (0, _toConsumableArray2['default'])(xAxis),
        (0, _toConsumableArray2['default'])(yAxis)
...
function mergeDefaultBoundaryGap(allAxis) {
    ...
    return [].concat(
        (0, _toConsumableArray2['default'])(valueAxis),
        (0, _toConsumableArray2['default'])(labelAxis)
    )
}
...
function calcValueAxisLabelData(valueAxis, series) {
    return valueAxis.map(function (axis) {
        ...
        var _getTrueMinMax = getTrueMinMax(axis, minMaxValue),
            _getTrueMinMax2 = (0, _slicedToArray2['default'])(
                _getTrueMinMax,
                2
            ),
...
function getSeriesMinMaxValue(series) {
    ...
    var minValue = Math.min.apply(
        ...
        (0, _toConsumableArray2['default'])(
            series.map(function (_ref9) {
                var data = _ref9.data
                return Math.min.apply(
                    Math,
                    (0, _toConsumableArray2['default'])(
                        (0, _util.filterNonNumber)(data)
                    )
                )
            })
        )
...
function getValueAxisLabelFromZero(min, max, interval) {
    ...
    return [].concat(
        (0, _toConsumableArray2['default'])(negative.reverse()),
        [0],
        (0, _toConsumableArray2['default'])(positive)
    )
}
...
function setAxisPosition(allAxis) {
    ...
    if (xAxis[0] && !xAxis[0].position)
        xAxis[0].position = _config.xAxisConfig.position
    ...
    if (yAxis[0] && !yAxis[0].position)
        yAxis[0].position = _config.yAxisConfig.position
...
function calcAxisTickPosition(allAxis, chart) {
    return allAxis.map(function (axisItem) {
        ...
        var _linePosition = (0, _slicedToArray2['default'])(linePosition, 2),
            _linePosition$ = (0, _slicedToArray2['default'])(
                _linePosition[0],
                2
            ),
            startX = _linePosition$[0],
            startY = _linePosition$[1],
            _linePosition$2 = (0, _slicedToArray2['default'])(
                _linePosition[1],
                2
            ),
        ...
        var tickLinePosition = getTickLinePosition(
            axis,
            boundaryGap,
            position,
            tickPosition,
...
function calcAxisNamePosition(allAxis, chart) {
    return allAxis.map(function (axisItem) {
        ...
        if (nameLocation === 'end')
            namePosition = (0, _toConsumableArray2['default'])(lineEnd)
