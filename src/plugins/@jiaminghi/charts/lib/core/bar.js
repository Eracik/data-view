...
function setBarNum(bars) {
    var barNum = (0, _toConsumableArray2['default'])(
        new Set(
            bars.map(function (_ref8) {
...
function calcBarLabelAxisCoordinate(bars) {
    return bars.map(function (bar) {
        ...
        var barLabelAxisPos = tickPosition.map(function (tick, i) {
            var barCategoryStartPos =
                tickPosition[i][coordinateIndex] - tickGap / 2
            var barItemsStartPos =
...
function getLeftEchelonShape(barItem, i) {
    ...
    var _barValueAxisPos$i = (0, _slicedToArray2['default'])(
            barValueAxisPos[i],
            2
        ),
...
function getRightEchelonShape(barItem, i) {
    ...
    var _barValueAxisPos$i2 = (0, _slicedToArray2['default'])(
            barValueAxisPos[i],
            2
        ),
...
function getNormalBarShape(barItem, i) {
    ...
    var _barValueAxisPos$i3 = (0, _slicedToArray2['default'])(
            barValueAxisPos[i],
            2
        ),
...
function getGradientParams(barItem, i) {
    ...
    var _barValueAxisPos$i4 = (0, _slicedToArray2['default'])(
            barValueAxisPos[i],
            2
        ),
