...
function mergeRadarAxisDefaultConfig(radar) {
  return (0, _util2.deepMerge)(
    (0, _util.deepClone)(_index.radarAxisConfig),
    radar
  )
}
...
function calcRadarAxisRingRadius(radarAxis, chart) {
  ...
  var maxRadius =
    Math.min.apply(Math, (0, _toConsumableArray2['default'])(area)) / 2
...
function calcRadarAxisLinePosition(radarAxis) {
  ...
  radarAxis.axisLinePosition = angles.map(function (g) {
    return _util.getCircleRadianPoint.apply(
      void 0,
      (0, _toConsumableArray2['default'])(centerPos).concat([radius, g])
    )
  })
  return radarAxis
}
...
function calcRadarAxisLabelPosition(radarAxis) {
  ...
  radarAxis.axisLabelPosition = axisLineAngles.map(function (angle) {
    return _util.getCircleRadianPoint.apply(
      void 0,
      (0, _toConsumableArray2['default'])(centerPos).concat([radius, angle])
    )
  })
  return radarAxis
}
...
function getSplitAreaStyle(radarAxis, i) {
  ...
  if (polygon) {
    var point1 = _util.getCircleRadianPoint.apply(
      void 0,
      (0, _toConsumableArray2['default'])(centerPos).concat([
        ringRadius[0],
        axisLineAngles[0]
      ])
    )

    var point2 = _util.getCircleRadianPoint.apply(
      void 0,
      (0, _toConsumableArray2['default'])(centerPos).concat([
        ringRadius[0],
        axisLineAngles[1]
...
function getAxisLableStyle(radarAxis, i) {
  var axisLabel = radarAxis.axisLabel,
    _radarAxis$centerPos = (0, _slicedToArray2['default'])(
      radarAxis.centerPos,
      2
    ),
  ...
  var _axisLabelPosition$i = (0, _slicedToArray2['default'])(
      axisLabelPosition[i],
      2
    ),
